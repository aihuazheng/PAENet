...
import os
import numpy as np
#'/data/panpeng/MMD/MMD1/save_model/margin_mmd1.40_sysu_c_tri_pcb_off_w_tri_2.0_share_net3_base_gm10_k4_p4_lr_0.1_seed_0_best.t'
...
parser.add_argument('--model_path', default='/data/panpeng/MMD/MMD1/save_model/', type=str,
                    help='model save path')
parser.add_argument('--save_epoch', default=100, type=int,
                    metavar='s', help='save model every 10 epochs')
parser.add_argument('--log_path', default='/data/panpeng/MMD/MMD1/log/', type=str,
                    help='log save path')
parser.add_argument('--vis_log_path', default='/data/panpeng/MMD/MMD1/log/vis_log/', type=str,
                    help='log save path')
...
def extract_query_feat(query_loader):
    ...
    with torch.no_grad():
        for batch_idx, (input, label ,atr_label) in enumerate(query_loader):
            ...
            input = Variable(input.cuda())
            if args.pcb == 'on':
                feat_pool = net(input, input,atr_label, test_mode[1])
...
model_path='/data/panpeng/MMD/MMD1/save_model/margin_mmd1.40_sysu_c_tri_pcb_off_w_tri_2.0_share_net3_base_gm10_k4_p4_lr_0.1_seed_0_best.t'
